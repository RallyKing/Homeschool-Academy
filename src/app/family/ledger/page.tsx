...
export default function FamilyLedgerPage() {
  ...
  async function onConfirmNullify() {
    ...
    try {
      ...
      setNullifyReason("");
      setMessage(
        "Log nullified. It stays in the ledger for audit but is excluded from progress totals. XP already awarded is not reversed.",
      );
    } catch (err) {
                ...
                <Row gap="sm">
                  ...
                  <Col span={12} md={6}>
                    ...
                    >
                      ...
                      <option value="native_completion">
                        Native completion
                      </option>
                          ...
                          <>
                            ...
                            <Button
                              ...
                              onClick={() => {
                                if (
                                  !window.confirm(
                                    "Permanently delete this log? This cannot be undone. Prefer Nullify to keep an audit trail.",
                                  )
                                ) {
                                  return;
                                }
                            ...
                            {!log.verifiedByParent ? (
                              <Button
                                ...
                                size="sm"
                                onClick={() =>
                                  void verify({ logId: log._id }).catch(
                                    (err) =>
                                      setError(
                                        err instanceof Error
                                          ? err.message
                              ...
                              <Button
                                ...
                                size="sm"
                                onClick={() =>
                                  void unverify({ logId: log._id }).catch(
                                    (err) =>
                                      setError(
                                        err instanceof Error
                                          ? err.message
